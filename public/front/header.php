...
<html lang="en">
  ...
  <body>
        ...
        <header class="bg-dark text-white header-main">
            <div class="container">
                <div class="row">
                    <div class="col-md-3"><p class="head-para">Sanjay Gandhi Biological Park</p></div>
  ...
  <section class="heading">
    <div class="container-fluid">
        <nav class="navbar navbar-expand-lg">
            <a class="navbar-brand" href="#"><img src="assets/img/main-logo.png" class="img-fluid logo-img" alt=""></a>
                ...
                <div class="collapse navbar-collapse heading-radius" id="navbarSupportedContent">
                    ...
                    <a class="navbar-brand" href="#"><img src="assets/img/Bihar-Govt-Logo.png" class="img-fluid logo-img1" alt=""></a>
                </nav>
          </div>
   </section>
